...
<head runat="server">
    ...
    <style>
        ...
        td {
            ...
            background-size: 1.65cm 1.7cm;
            background-position: -1.5px -0.9px;
            border: 1px solid black;
            text-align: center;
            font-size: 44px;
                                    ...
                                    <form runat="server" action="Plantilla.aspx" method="post">
                                        ...
                                        <div>
                                            ...
                                            <asp:Panel runat="server" ID="cantidad">
                                                ...
                                                <asp:TextBox runat="server" ID="tbhasta" placeholder="Hasta" size="5"></asp:TextBox>
                                                <asp:LinkButton runat="server" ID="generar" OnClick="generar_OnClick">Generar</asp:LinkButton>
                                            </asp:Panel>
                                        </div>
                                        <div class="text-center">
                                            <%--<iframe id="iframePaginaHija" name="iframePaginaHija" src="tabla.html" width="880" height="400"></iframe>--%>
                                        </div>
                                    </form>
                                </div>
