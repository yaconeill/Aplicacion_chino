...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">BD Palabras en Chino</a>
            </div>
            <!-- /.navbar-header -->
                                    ...
                                    <div class="table-striped">
                                        <asp:GridView ID="GVpalabras" runat="server"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:ButtonField HeaderText="Ver" ButtonType="Button" CommandName="mostrar" />
                                            </Columns>
                                        </asp:GridView>
                                    </div>
                                </form>
    ...
    <div class="modal fade" id="mostrarpalabra" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div>
                        <label for="plibro">Palabra</label>
                        <input id="plibro" name="plibro" />
                        <label for="ppron">Pronunciación</label>
                        <input id="ppron" name="ppron" />
                        <label for="pdef">Definición</label>
                        <input id="pdef" name="pdef" />
